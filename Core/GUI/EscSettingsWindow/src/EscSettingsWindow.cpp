...
EscSettingsWindow::EscSettingsWindow()
{

    std::cout<<"Start  window"<<std::endl;
}

void EscSettingsWindow::show(SDL_Window * window, SDL_Renderer * renderer) {
    ...
    gui::MenuItem menuItems[] = {
            ...
            { "MouseSettings", gui::GuiButtons::MouseSettings,        { 300, 350, 200, 50 } },
            { "GameDifficultySettings", gui::GuiButtons::GameDifficultySettings,            { 300, 425, 200, 50 } },
                    ...
                    for (int i = 0; i < numMenuItems; i++) {
                        if (mouseX >= menuItems[i].pos.x && mouseX <= menuItems[i].pos.x + menuItems[i].pos.w &&
                            ...
                            switch (menuItems[i].button) {
                                ...
                                case gui::GuiButtons::GameDifficultySettings:
                                {
                                    quit = true;
                                    m_stateWindow = StateWindow::GameDifficultySettings;
                                    break;
                                }
...
EscSettingsWindow::StateWindow EscSettingsWindow::stateWindow() const {
