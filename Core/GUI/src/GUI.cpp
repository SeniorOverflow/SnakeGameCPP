...
GUI::GUI() {
  ...
  m_window = SDL_CreateWindow("GameWindow",               // window title
                              SDL_WINDOWPOS_UNDEFINED,    // initial x position
                              SDL_WINDOWPOS_UNDEFINED,    // initial y position
                              windowWeight, windowHeight, // width, in pixels
                              SDL_WINDOW_SHOWN            // height, in pixels
                                                          // flags - see below

  );
  //   SDL_Window* window = SDL_CreateWindow("My Core", SDL_WINDOWPOS_CENTERED,
  ...
  //  SDL_Renderer* renderer = SDL_CreateRenderer(m_window, -1,
...
void GUI::onVeryLow() { m_difficulty = GameDifficulty::VeryLow; }

void GUI::onLow() { m_difficulty = GameDifficulty::Low; }

void GUI::onMiddle() { m_difficulty = GameDifficulty::Middle; }

void GUI::onHard() { m_difficulty = GameDifficulty::Hard; }

void GUI::onNightmare() { m_difficulty = GameDifficulty::Nightmare; }
...
GameDifficulty GUI::selectedDifficulty() const { return m_difficulty; }

SDL_Window *GUI::window() { return m_window; }

SDL_Renderer *GUI::renderer() { return m_renderer; }

GUI::State GUI::guiState() const { return m_guiState; }
